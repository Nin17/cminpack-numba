...
def _hybrj_overload(
    ...
    _hybrd_cfunc = Cminpack.hybrj(x.dtype)
...
def _hybrj_args(x):
    ...
    return n, fvec, nfevptr, njevptr, fjac, ldfjac, lr, r, qtf, wa1, wa2, wa3, wa4
...
def hybrj(
    ...
    """
    n, fvec, nfevptr, njevptr, fjac, ldfjac, lr, r, qtf, wa1, wa2, wa3, wa4 = (
        _hybrj_args(x)
    )
